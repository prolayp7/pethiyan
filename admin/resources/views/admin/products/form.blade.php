                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" min="0" class="form-control" name="weight" value="{{ $singleProductVariant->weight ?? '' }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" min="0" class="form-control" name="height" value="{{ $singleProductVariant->height ?? '' }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" min="0" class="form-control" name="length" value="{{ $singleProductVariant->length ?? '' }}">
                                            <span class="input-group-text">CM</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" min="0" class="form-control" name="breadth" value="{{ $singleProductVariant->breadth ?? '' }}">
                                            <span class="input-group-text">CM</span>
                                        </div>
                                    </div>
                                </div>
