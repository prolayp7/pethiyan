...
LCommerce enables multiple independent sellers to list and sell products on a single platform under a unified customer experience. Key traits:
...
└── LCommerce_API.postman_collection.json  # Postman API collection
```
...
For the full collection, import `LCommerce_API.postman_collection.json` into Postman.
