...
export default function CategoryCard({ category, postCount }: CategoryCardProps) {
  return (
    <Link
      ...
      className="group block rounded-[24px] border border-slate-200/80 bg-white p-5 shadow-[0_12px_40px_rgba(15,23,42,0.05)] transition duration-300 hover:-translate-y-1 hover:border-slate-300 hover:shadow-[0_20px_60px_rgba(15,23,42,0.1)]"
    >
