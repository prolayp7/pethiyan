...
const sections: SeoSection[] = [
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <Link href="/categories/standup-pouches" className="text-blue-400 hover:underline">standup pouches</Link>{" "}
  ...
  },
  {
    ...
    body: (
      <>
        Our{" "}
        <Link href="/categories/ziplock-pouches" className="text-blue-400 hover:underline">ziplock bags</Link>{" "}
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <Link href="/categories/custom-packaging" className="text-blue-400 hover:underline">custom packaging</Link>{" "}
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <Link href="/categories/eco-packaging" className="text-blue-400 hover:underline">eco packaging</Link>{" "}
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <Link href="/bulk" className="text-blue-400 hover:underline">bulk orders</Link>{" "}
        and{" "}
        <Link href="/wholesale" className="text-blue-400 hover:underline">wholesale packaging</Link>.{" "}
...
export default function FooterSeoContent() {
  return (
    <div
      style={{
        background: "linear-gradient(180deg, #050b19 0%, #040a17 100%)",
    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-10">
        ...
        <p className="text-sm leading-relaxed mb-6" style={{ color: "rgba(255,255,255,0.50)" }}>
          ...
          <Link href="/categories/ziplock-pouches" className="text-blue-400 hover:underline">ziplock bags</Link>,{" "}
          <Link href="/categories/custom-packaging" className="text-blue-400 hover:underline">custom packaging</Link>,{" "}
          <Link href="/categories/eco-packaging" className="text-blue-400 hover:underline">eco-friendly packaging</Link>,{" "}
